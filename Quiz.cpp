...
int main()
{
    ...
    setlocale(0, "");
    int menu;
    const int QUESTIONSIZE = 30;// количество вопросов
    const int ANSWERSIZE = 4; //количество вариантов ответа на каждый вопрос
    int questionsCount = 10;// количество вопросов в игре
    int livesCount = 3;// количество жизней     
    bool fiftyFifty = false;//возможность использования подсказки "пятьдесят на пятьдесят"
    int intfiftyFifty;
    int gameTime = 5; //время на ответ на вопрос.
    int UserAnswer;
    string PravilnAnswell[QUESTIONSIZE] //содержатся правильные ответы на каждый вопрос игры
    {
        "в 1789-1799 годах" ,
        "ом" ,
        "Samsung" ,
    ...
    for (int i = 0; i < QUESTIONSIZE; i++)// рандомайзер рандомных чисел
    {
        int num;
        bool unique;
        do {
    ...
    for (int i = 0; i < QUESTIONSIZE; i++)
    {
        for (int j = 0; j < ANSWERSIZE; j++)
        {
            ...
            ArrRandAnswer[j] = num;//рандомайзер для вариантов ответов
        }
    }
    ...
    while (true)
    {
        ...
        case 3:
            ...
            for (int i = 0; i < questionsCount; i++)
            {
                ...
                cout << "У вас осталось " << livesCount << " жизней" << endl;//Выводится количество жизней, оставшихся у игрока.
                ...
                if (fiftyFifty) {
                    ...
                    if (intfiftyFifty == 1) {
                        ...
                        for (int j = 0; j < ANSWERSIZE; j++) {
                            if (answer[ArrRandQuestion[i]][ArrRandAnswer[j]] != PravilnAnswell[ArrRandQuestion[i]]) {       
                                    cout << "  " << symbol[ArrRandAnswer[j]] << " <подсказка недоступна>" << endl; //Если количество совпадений равно 2, то выводится сообщение о недоступности подсказки.
                                }
                                else {
